...
## [1.49.0](https://github.com/fengjixuchui/emp3r0r/compare/v1.48.0...v1.49.0) (2025-01-14)


### Features

* `file_downloader` that downloads files from agent hosted HTTP server, for data exfiltration, with checksum support ([969f153](https://github.com/fengjixuchui/emp3r0r/commit/969f153ce72b6e4533d4f7cc682ff847887f5309))
* `file_server` for file transfer between agents ([ad83344](https://github.com/fengjixuchui/emp3r0r/commit/ad833443cca7314be2980edd9e7a46427fb644c2))
* add http stager (with AES encryption) and independent HTTP listener ([66f4d8c](https://github.com/fengjixuchui/emp3r0r/commit/66f4d8cc23a31381d57d93dec11478c7234fc87e))
* add mimikatz (no AV evasion) ([f1a44fc](https://github.com/fengjixuchui/emp3r0r/commit/f1a44fcf74303d56fd89005e9233476807960d26))
* add Shadowsocks TCP tunnel support, can be used for port_fwd, C2 transport relaying ([bdf9f56](https://github.com/fengjixuchui/emp3r0r/commit/bdf9f5680bb6fd40251400ebf021b60e1f378878))
* add standalone `elvish` cross-platform shell ([a97c51e](https://github.com/fengjixuchui/emp3r0r/commit/a97c51eba89a14e43857ca475eab1af300132609))
* agent side "listener" for lateral movement and payload delivery ([c4b40b8](https://github.com/fengjixuchui/emp3r0r/commit/c4b40b82f25f590da11c53cbcc11b300a7698dab))
* broadcasted auto_proxy is now using shadowsocks ([b31562b](https://github.com/fengjixuchui/emp3r0r/commit/b31562b3eeea756679712a63e048725a795ad9eb))
* C2 relay via SSH ([522b6b3](https://github.com/fengjixuchui/emp3r0r/commit/522b6b37779d34d674ed4bc47842692ef944875f))
* deprecate `gen_agent` cmd in favor of `use gen_agent` module ([add0a7e](https://github.com/fengjixuchui/emp3r0r/commit/add0a7eb1b0a0ed916a4b298c4712661421783e9))
* enable `upgrade_cc` command (WIP) ([63b2384](https://github.com/fengjixuchui/emp3r0r/commit/63b23847233c0f1dbf501add32d46f5c26b3bccb))
* hide PIDs and files using loader.so ([c54c5f5](https://github.com/fengjixuchui/emp3r0r/commit/c54c5f53522c5c93270c5189d6f54d30ee9a050c))
* integrate donut (WIP) ([93c76f2](https://github.com/fengjixuchui/emp3r0r/commit/93c76f24fbf6231f7d11f2229da3ef44cb9eac14))
* module help for `gen_agent` ([ea3cfe7](https://github.com/fengjixuchui/emp3r0r/commit/ea3cfe7c7c8eac444d63662f894b9ef9c016f05b))
* process `mem_dump` for Linux and Windows ([b8a9822](https://github.com/fengjixuchui/emp3r0r/commit/b8a98229b697104c2a95921375c2170c6c494aaf))
* remove shell pane ([86851d2](https://github.com/fengjixuchui/emp3r0r/commit/86851d2a55000f50a3c149b349032f0dc199a577))
* revamp `lpe_helper` ([94d3601](https://github.com/fengjixuchui/emp3r0r/commit/94d3601ce45baa4df8af019a03e5f2d46ab056d1))
* support DLL agent stub (`amd64` only) ([eda0e94](https://github.com/fengjixuchui/emp3r0r/commit/eda0e94cc30f82bc80b6e4dbbcddffded8da4265))
* support in-memory ps1 modules ([959517b](https://github.com/fengjixuchui/emp3r0r/commit/959517bf43c547c9fdaad503a1ce81343048d017))
* support payload compression in stager ([97b271a](https://github.com/fengjixuchui/emp3r0r/commit/97b271a9774cac8a15de58dd26727ab17034ff26))
* transparent zstd compression for file downloading from agents ([e4144c5](https://github.com/fengjixuchui/emp3r0r/commit/e4144c5f543e9642411888169b76972143be8605))
* upgrade tmux config ([d5fc0d0](https://github.com/fengjixuchui/emp3r0r/commit/d5fc0d0edcf944c2089071b855f12d56b62edbe3))


### Bug Fixes

* [#236](https://github.com/fengjixuchui/emp3r0r/issues/236) ([84e1fda](https://github.com/fengjixuchui/emp3r0r/commit/84e1fdacb0320d7c83cec7dea1a604749919c82f))
* [#244](https://github.com/fengjixuchui/emp3r0r/issues/244) ([50a0221](https://github.com/fengjixuchui/emp3r0r/commit/50a0221c614c831f426086a5a15f914fcb70cee6))
* [#246](https://github.com/fengjixuchui/emp3r0r/issues/246) ([da2bfd1](https://github.com/fengjixuchui/emp3r0r/commit/da2bfd11729a729e8d4925862ab9b947c9795356))
* [#248](https://github.com/fengjixuchui/emp3r0r/issues/248) ([e89155d](https://github.com/fengjixuchui/emp3r0r/commit/e89155d2c14a73ed7d834be214ced9d0ada37227))
* [#250](https://github.com/fengjixuchui/emp3r0r/issues/250) ([c01340d](https://github.com/fengjixuchui/emp3r0r/commit/c01340d2651ce5ab4260b1955b23fac6fbf1c57f))
* [#250](https://github.com/fengjixuchui/emp3r0r/issues/250) ([99b2fb0](https://github.com/fengjixuchui/emp3r0r/commit/99b2fb04bb33a0c4f62ac7a8d6dc08192259a0da))
* [#253](https://github.com/fengjixuchui/emp3r0r/issues/253) ([2ebb6f4](https://github.com/fengjixuchui/emp3r0r/commit/2ebb6f42434b38cc458fa6b2a7ec1a72ec3c18ce))
* [#264](https://github.com/fengjixuchui/emp3r0r/issues/264) add option to disable timeout in proxy altogether ([e8b31e5](https://github.com/fengjixuchui/emp3r0r/commit/e8b31e59d5d439e1dff143a541e8c0a67d0141ec))
* [#264](https://github.com/fengjixuchui/emp3r0r/issues/264) disable timeout and leave cleanup job to the OS ([d3cea97](https://github.com/fengjixuchui/emp3r0r/commit/d3cea97539474e779d1a03c1f7cd805c8e84893c))
* [#264](https://github.com/fengjixuchui/emp3r0r/issues/264) increase timeout to 2 minutes ([cc7034d](https://github.com/fengjixuchui/emp3r0r/commit/cc7034d3914295ccf55fffa87e9269b7126b6d3d))
* [#292](https://github.com/fengjixuchui/emp3r0r/issues/292) DLL agent ([dddd442](https://github.com/fengjixuchui/emp3r0r/commit/dddd4421f9f103d31b2f80acb7ff4faf1fe76014))
* [#318](https://github.com/fengjixuchui/emp3r0r/issues/318) ([ac2a682](https://github.com/fengjixuchui/emp3r0r/commit/ac2a682b224d43382e7ac48320b7b3450547955c))
* [#345](https://github.com/fengjixuchui/emp3r0r/issues/345) ([b2ea89c](https://github.com/fengjixuchui/emp3r0r/commit/b2ea89c91343c67344a7494603ee18a780b38fe9))
* [#5](https://github.com/fengjixuchui/emp3r0r/issues/5)  `fork` not supported on `arm64` ([d962876](https://github.com/fengjixuchui/emp3r0r/commit/d9628769f889c0ab8848f60daaf2c8b3065d0465))
* `__libc_dlopen_mode` deprecated in favor of `dlopen` as libdl.so has been merged into libc.so ([5285b93](https://github.com/fengjixuchui/emp3r0r/commit/5285b93d9fc3f63242c903d3e832ebee6f10ac28))
* `__libc_dlopen_mode` not found ([322d071](https://github.com/fengjixuchui/emp3r0r/commit/322d0719fcb9182b5f5a94e071ad367e9d585eec))
* `-connect_relay` unable to recovery SSH session ([8bde2fb](https://github.com/fengjixuchui/emp3r0r/commit/8bde2fbc7aa9b215e8b0cf8f3fc6a85f56b3e964))
* `-gencert` refuses to work when `emp3r0r.json` not found ([f100936](https://github.com/fengjixuchui/emp3r0r/commit/f100936ef288eadb6045c67bc5d1c165fa0f9c5b))
* `bring2cc` accidentally disabled ([ec11524](https://github.com/fengjixuchui/emp3r0r/commit/ec115249ff8b53499dc97010220eda577b78e81c))
* `bring2cc` fails to connect configure SOCKS5 proxy ([d11c8f0](https://github.com/fengjixuchui/emp3r0r/commit/d11c8f08c802d9a9662e603f6a6611e751c0d0a1))
* `bring2cc` should start SOCKS5 server automatically ([48b7311](https://github.com/fengjixuchui/emp3r0r/commit/48b7311dc3096e2cd9e3f9047cd64b3a03e1b48b))
* `file_downloader` should have an option to opt out of checksum verification ([27529ff](https://github.com/fengjixuchui/emp3r0r/commit/27529ff4ce4d9ec6089098ac07721142de73f12a))
* `file_server` http port should be random ([b570cd0](https://github.com/fengjixuchui/emp3r0r/commit/b570cd0e5427a0c569a1c16964449e9a8da0033b))
* `FileBaseName` needs to strip `/` ([4eca34b](https://github.com/fengjixuchui/emp3r0r/commit/4eca34b651c01abf61c1b5a64221a78146516136))
* `gen_agent` should abort when OS choice is invalid ([a8c2142](https://github.com/fengjixuchui/emp3r0r/commit/a8c21423e9d4ef672ac163575f17b2d54fde550b))
* `go-console` fails to start winpty ([e7e2939](https://github.com/fengjixuchui/emp3r0r/commit/e7e2939b572053e44d3b41c5cc6bd8635b7958f1))
* `grab` creates on-disk file even if no path is specified ([dfbf640](https://github.com/fengjixuchui/emp3r0r/commit/dfbf640276bc46819df6b526421ae1ea34ba2ec5))
* `label` by tag not working ([131d84e](https://github.com/fengjixuchui/emp3r0r/commit/131d84e1f1aa2e888978adaedd6876b61cd9e2ce))
* `lpe_linpeas` unable to run ([a32187f](https://github.com/fengjixuchui/emp3r0r/commit/a32187f7bd776a7e364405330bfd304964cf1855))
* `lpe_winpeas` for Windows LPE ([a79f8a2](https://github.com/fengjixuchui/emp3r0r/commit/a79f8a2b4e260dcbaa71465214acd5cd90c217af))
* `makeTransport` takes forever to fail, let's make it 10s top ([7ccb64b](https://github.com/fengjixuchui/emp3r0r/commit/7ccb64b6db7b5b09b0b42ba91e8a08a8804a461b))
* `passProxy` proxy URL parsing error ([957395e](https://github.com/fengjixuchui/emp3r0r/commit/957395edc369dbf51463af11d061c2421a20343d))
* `ps` command output not parsed ([7ace03c](https://github.com/fengjixuchui/emp3r0r/commit/7ace03c4d882db7980e63df0879f9daf8290d81f))
* `run_as_daemon` should always be enabled ([11a3979](https://github.com/fengjixuchui/emp3r0r/commit/11a39793e16564ced29907bf5439ebca723177fd))
* `split-window -l` needs `%` to specify percentage ([266f195](https://github.com/fengjixuchui/emp3r0r/commit/266f195a6ac932ea9b3000b027dc668c3008160f))
* `split-window -p &lt;size&gt;` has been deprecated in tmux newer versions ([d625d87](https://github.com/fengjixuchui/emp3r0r/commit/d625d87d0ca2d2f7b4e0bf69e4decae06da037ec))
* `stager.so` non-debug build lacks AES support ([679b755](https://github.com/fengjixuchui/emp3r0r/commit/679b755a50350e8814bebae6dd4698ff0e8b7d5f))
* `unarchive` secure path validation ([ce61818](https://github.com/fengjixuchui/emp3r0r/commit/ce618182704c3f0f92974163c9fba20f2927a119))
* `Unarchive` with `archiver/v4` implementation ([fc96304](https://github.com/fengjixuchui/emp3r0r/commit/fc96304c4524d14242bab9ac7c9251cbda8573f7))
* `upgrade_agent` not working ([ab296aa](https://github.com/fengjixuchui/emp3r0r/commit/ab296aa6f1e639c33fc36b75c3de23d015a26c20))
* `VERBOSE=true` not working ([b7894c4](https://github.com/fengjixuchui/emp3r0r/commit/b7894c463e7a178ebc6b8cc51f116a4e0afa594d))
* 1. option to disable NCSI check 2. upgrade deps ([5a14b7a](https://github.com/fengjixuchui/emp3r0r/commit/5a14b7a741e905a64c3d3b05db0643bd2ce0b840))
* 254 ([a9f3674](https://github.com/fengjixuchui/emp3r0r/commit/a9f36743fcc4c2c8e5085f9318c335280eb361fd))
* add `config.json` for `mimikatz` module ([a99139c](https://github.com/fengjixuchui/emp3r0r/commit/a99139cf819cad3709c46b93b2d499f2b7027849))
* add instructions ([c051806](https://github.com/fengjixuchui/emp3r0r/commit/c051806a6c042501658623b26ade3d7995b6baf0))
* add plain HTTP listener ([a480f30](https://github.com/fengjixuchui/emp3r0r/commit/a480f306611afdaf10f114a84da4909c7f4e81e2))
* add some nil dereference check to improve stability ([6710ed7](https://github.com/fengjixuchui/emp3r0r/commit/6710ed73f31fd58dba57af22733cad03ded32667))
* adjust logging text colors ([ba1c133](https://github.com/fengjixuchui/emp3r0r/commit/ba1c133dfaf732a81cc8b49695744dfb1ca63d37))
* AES decryption in stager ([757a386](https://github.com/fengjixuchui/emp3r0r/commit/757a386969f519c45fea5ec0802e6ea3fe0297ae))
* AES encryption: use GCM for authentication ([e713898](https://github.com/fengjixuchui/emp3r0r/commit/e713898da991df9306a1ac5ce133aa93f913b6e8))
* agent aborts connection (Windows) ([8c73193](https://github.com/fengjixuchui/emp3r0r/commit/8c731935b440ff4828ed4aa23bc8ee8bd6148f31))
* agent aborts connection when C2 is unreachable ([def1b2a](https://github.com/fengjixuchui/emp3r0r/commit/def1b2a453931dc8e2490749b649720b6eedb289))
* agent authentication ([a2386e2](https://github.com/fengjixuchui/emp3r0r/commit/a2386e2c0acc5305e4e65f0bcd244b12b15fc778))
* agent dies on unix socket error ([f0757fe](https://github.com/fengjixuchui/emp3r0r/commit/f0757fe9127a04be0c7ee3c7ef724757853f06e1))
* agent path names ([2b2773a](https://github.com/fengjixuchui/emp3r0r/commit/2b2773a084ced9ed172bee2426b9f1939486fffc))
* agent root directory missing `/` ([a3ef9b4](https://github.com/fengjixuchui/emp3r0r/commit/a3ef9b49312b995b9576e9a60d4f91a6ba721e33))
* agent root naming in Windows ([ff6ee40](https://github.com/fengjixuchui/emp3r0r/commit/ff6ee401658508b57e3daaf1b2059de295153757))
* agent root path searching ([aa0941c](https://github.com/fengjixuchui/emp3r0r/commit/aa0941cc90ee4021d603c8aa75cbd3c55b44c022))
* agent system info pane not being updated ([5e9a8ab](https://github.com/fengjixuchui/emp3r0r/commit/5e9a8abb2755076e2fdf80a62517ad2d933ab91a))
* agent wait queue ([28dadaa](https://github.com/fengjixuchui/emp3r0r/commit/28dadaa76f4385bc13a52fdda0e9b5aad6782e73))
* argv modification is not needed in Windows ([b5915c6](https://github.com/fengjixuchui/emp3r0r/commit/b5915c6a1841edf3d475321229b436fb97e32190))
* auto completion fix ([571fd0c](https://github.com/fengjixuchui/emp3r0r/commit/571fd0c65d03971bc6645f40eb348965d7798287))
* auto proxy broken ([7b04571](https://github.com/fengjixuchui/emp3r0r/commit/7b045715213229b2afb10d9ee71416bbefd29b31))
* auto-complete `gen_agent` module options ([71e7d79](https://github.com/fengjixuchui/emp3r0r/commit/71e7d79fc5621db731d53a6f205143d0ea889792))
* auto-updating hide_pid list ([7a2d822](https://github.com/fengjixuchui/emp3r0r/commit/7a2d8227f23a81558f82c345a5f1e4ceeb21d5b9))
* bash stager unable to execute agent ([f406100](https://github.com/fengjixuchui/emp3r0r/commit/f4061006fe50b79730e186e204cc2a20611416cc))
* be silent when started by loader.so ([4113d3d](https://github.com/fengjixuchui/emp3r0r/commit/4113d3d675669be21fa5d3c7a54523f36ffd6d6a))
* build: switch to `zstd` ([d7e1eeb](https://github.com/fengjixuchui/emp3r0r/commit/d7e1eeb8d9b02c2a6e71cb8e4805e05fba8f657b))
* C2 CLI log is written to unexpected location ([332a96b](https://github.com/fengjixuchui/emp3r0r/commit/332a96b91fc84ab03b7be5273ac5eec221d7cd5d))
* c2 commands refactor ([fb46ae8](https://github.com/fengjixuchui/emp3r0r/commit/fb46ae8a3f3042b354139f0b0d9d0528321cef7a))
* C2 relay client ([7e121d6](https://github.com/fengjixuchui/emp3r0r/commit/7e121d664b2cc9eaaeb2cf4b316f11e7c25d29e1))
* C2 relay: C2 service not running ([4a26931](https://github.com/fengjixuchui/emp3r0r/commit/4a2693135df576c5b86f7c6c0197069d0c772d69))
* CC has no knowledge of agent root location, causing custom module to fail ([ca5f5da](https://github.com/fengjixuchui/emp3r0r/commit/ca5f5da53e03d69b4cc7b584463d8af4ae94ba1d))
* CC unable to detect existing instance ([15e2940](https://github.com/fengjixuchui/emp3r0r/commit/15e2940c1fd379eb2666bd82c2b69f44f2d78519))
* change prompt style when having root access ([3a46fd6](https://github.com/fengjixuchui/emp3r0r/commit/3a46fd6db3002a840c6aceaf62508d0326a8fcee))
* chdir error when running custom modules ([66a699f](https://github.com/fengjixuchui/emp3r0r/commit/66a699f83bfb2994aa1a86635cd2bb664dfc3b90))
* check if local version is already the latest ([0abb4a0](https://github.com/fengjixuchui/emp3r0r/commit/0abb4a06a2bf7b2691d8b42836493b1feac321ca))
* check target OS compatibility before running modules ([aac0b85](https://github.com/fengjixuchui/emp3r0r/commit/aac0b85b8771a4774dfc645efec10383c9645adf))
* cli crash ([d65907a](https://github.com/fengjixuchui/emp3r0r/commit/d65907aef1a5d31d95645cf80e5cde58789bc23e))
* collect module output ([40fd645](https://github.com/fengjixuchui/emp3r0r/commit/40fd6458173ddd815d617e06cf2e0b9ed9fd353b))
* compressor issue in `arc`, sync with upstream ([2a18bf8](https://github.com/fengjixuchui/emp3r0r/commit/2a18bf866a78333f49f78c7717faae25032e35b7))
* connectivity check should connect to C2 using uTLS ([8b746c5](https://github.com/fengjixuchui/emp3r0r/commit/8b746c5bf38e6300362e8b42f750c1f1e83e0fb9))
* crash when listing module options ([32cdc3d](https://github.com/fengjixuchui/emp3r0r/commit/32cdc3dd91d013021282b3e8854fa6f9ad74d1ff))
* crash when using `info` with no module selected ([a2706c9](https://github.com/fengjixuchui/emp3r0r/commit/a2706c908f29113bb20b90b0e0ed6fb7054b295e))
* critical bug: NCSI checking prevents proxied agents from getting online ([eaede74](https://github.com/fengjixuchui/emp3r0r/commit/eaede74882b7e7694709bca940671104ddfb7003))
* delete orphaned functions ([7b744c1](https://github.com/fengjixuchui/emp3r0r/commit/7b744c11fb2151c27aa895bf650286aaf52a7aa1))
* deprecate MS NCSI as it doesn't support HTTPS ([62f2115](https://github.com/fengjixuchui/emp3r0r/commit/62f21154b29daddfb944670fd334a5b18ce2f9c6))
* deprecated `rand.seed` ([1515072](https://github.com/fengjixuchui/emp3r0r/commit/151507267235746bc937c2d16e9338126fbb3f36))
* disable `HidePIDs` until we find a better way ([1fc1494](https://github.com/fengjixuchui/emp3r0r/commit/1fc149475f69628935547c6164a2a1dbc63b3664))
* disable automatic `vaccine` download, it should be run when needed ([20037a4](https://github.com/fengjixuchui/emp3r0r/commit/20037a40368efde4fce8d6686284062d6fbd76a0))
* disable damned `chunked encoding` ([b1b0a79](https://github.com/fengjixuchui/emp3r0r/commit/b1b0a798f19621319f929684db5ed4fd6dd72f79))
* distinguish types of modules for better handling ([4daebde](https://github.com/fengjixuchui/emp3r0r/commit/4daebde60ffa41519680c763adf53363eb46d4ed))
* do not attemp to hide without root ([b69f6b1](https://github.com/fengjixuchui/emp3r0r/commit/b69f6b116edce85c6185b33ba578c4e43361f8e4))
* do not create any files in Windows ([82975d7](https://github.com/fengjixuchui/emp3r0r/commit/82975d785837f8339cd6e4ba53d582c67326b6a8))
* do not delay when started by loader.so ([ca596e9](https://github.com/fengjixuchui/emp3r0r/commit/ca596e91ac4b8286bb9e7e0763b1deb785eae09e))
* do not open SFTP pane in Windows ([1e6342f](https://github.com/fengjixuchui/emp3r0r/commit/1e6342f0f7ef52837819705cdc76617e34f10427))
* do not overwrite backup ([ef0b058](https://github.com/fengjixuchui/emp3r0r/commit/ef0b05808e7f7cfaac51ceeb41575dadbcdad0dd))
* do not prompt for indicator text when it's disabled ([f6e8c62](https://github.com/fengjixuchui/emp3r0r/commit/f6e8c62b7f35e9cb90906be9c53b70cdb6be7186))
* do not request full path to download ([55c463e](https://github.com/fengjixuchui/emp3r0r/commit/55c463e028f0b283f81e2fe86e7449f206a7977e))
* dont print binary data to the terminal ([f3603a2](https://github.com/fengjixuchui/emp3r0r/commit/f3603a2008cad27480d0871b028c2104206f4869))
* dont use `.exe` for Linux agents ([1b55009](https://github.com/fengjixuchui/emp3r0r/commit/1b55009649bf2a170304b55f1db246ffcc045d4f))
* ELF header parser ([c037902](https://github.com/fengjixuchui/emp3r0r/commit/c0379023ad40f6b633600f7465034fd12de3b195))
* emp3r0r should exit after executing `-gencert` ([33edc36](https://github.com/fengjixuchui/emp3r0r/commit/33edc36d40861324a1dac6d980978d4150ceaca1))
* exec system commands with args ([e41875f](https://github.com/fengjixuchui/emp3r0r/commit/e41875f63ae11b56091d5028c9f78bc1e30a4665))
* fatal error in unix socket listener ([1cd3065](https://github.com/fengjixuchui/emp3r0r/commit/1cd3065f044eb281b7701e385b8b88ecc91721d1))
* fs commands ([4336af2](https://github.com/fengjixuchui/emp3r0r/commit/4336af211d554edaf8644cc978b6167e442f12b6))
* handle AES decryption panic ([48e362e](https://github.com/fengjixuchui/emp3r0r/commit/48e362ef7de8c5d9a9c5bf80f2160921708ab059))
* handling of compression of in-mem modules ([47c20ae](https://github.com/fengjixuchui/emp3r0r/commit/47c20ae849619a703e9d95c815f8c7aece278113))
* handling of in-memory script modules ([f22163a](https://github.com/fengjixuchui/emp3r0r/commit/f22163a524dd16d9b1abe404fdc73b6a7aacc2f5))
* help user understand how stager URL works ([71905e5](https://github.com/fengjixuchui/emp3r0r/commit/71905e57775d3c969cc6ce010aa9862af8610bc8))
* hidden_pids list gets overwritten ([fbf7c9c](https://github.com/fengjixuchui/emp3r0r/commit/fbf7c9c7b0963611d20b66481d8ad46b5337c0d0))
* high CPU usage by emp3r0r-cat (probably related to [#315](https://github.com/fengjixuchui/emp3r0r/issues/315)) ([7854a07](https://github.com/fengjixuchui/emp3r0r/commit/7854a070d9bccd6eec582d7ea716e497a993a455))
* igonore cmdline args when run as DLL ([4dd830e](https://github.com/fengjixuchui/emp3r0r/commit/4dd830e64920c9de9e35bff3e93e34cacd9b12f3))
* improve command parsing ([e5baccb](https://github.com/fengjixuchui/emp3r0r/commit/e5baccb4ffd3d49dcee27b3c8434bcd538489dc3))
* improve downloading from C2, add checksum verification ([459bdab](https://github.com/fengjixuchui/emp3r0r/commit/459bdabbc25187704f1be880f814a2087f5824d1))
* improve module management and code refactoring ([656a652](https://github.com/fengjixuchui/emp3r0r/commit/656a652b7c4e5776bbcf0cc4a06f3d80491cef0e))
* in-memory execution of ps1 modules ([d755ae6](https://github.com/fengjixuchui/emp3r0r/commit/d755ae67e0f7748af754fa88654d485f3108c787))
* inaccurate waitqueue count ([4eeacf6](https://github.com/fengjixuchui/emp3r0r/commit/4eeacf6af9dd5881fdf3311b59f67061bad9cac3))
* incomplete downloads cannot be resumed ([bbd57f9](https://github.com/fengjixuchui/emp3r0r/commit/bbd57f98e93fe44d37e339b0708e21742c8fa66d))
* installer not run when updating CC ([b0f25de](https://github.com/fengjixuchui/emp3r0r/commit/b0f25de2deefd6ac440b0774d86a4ebcfd373699))
* int overflow and build issue ([6fe9ee3](https://github.com/fengjixuchui/emp3r0r/commit/6fe9ee365888b65a6d5abc7c89722d75a28e34e9))
* KCPClient should exit when reverse proxy session ends ([51d02e4](https://github.com/fengjixuchui/emp3r0r/commit/51d02e4e0f8a64b3b5639d201a747a15cf36c550))
* loader.so should return error for non-`amd64` ([4170414](https://github.com/fengjixuchui/emp3r0r/commit/41704149f3a511dda9beea668dc04968d7a9aa9c))
* loader.so unable to find exe due to malformed path name ([eec2dcc](https://github.com/fengjixuchui/emp3r0r/commit/eec2dcc05adecdb89bcb9321b2a4df0778dc95f6))
* log filename ([8dff46a](https://github.com/fengjixuchui/emp3r0r/commit/8dff46aa369092b8f20f7ad03aaf8950ab8adaf4))
* long lines in `System Info` pane ([ef6f1d9](https://github.com/fengjixuchui/emp3r0r/commit/ef6f1d925abc8f2127c32f17b2d1ad3f68f6b32a))
* make it possible to download modules from specified agent file server ([4f178b5](https://github.com/fengjixuchui/emp3r0r/commit/4f178b5f11b6c150498e26aa730302a3de3275b6))
* make sure stdin closes ([a328ea8](https://github.com/fengjixuchui/emp3r0r/commit/a328ea8cf1acbbfe67cd4874f570f2997725b64a))
* messy logging in kcptun ([ea2aa88](https://github.com/fengjixuchui/emp3r0r/commit/ea2aa885718ab3fa0388ba37164651a8723ac2d2))
* mimikatz's documentation ([3741b36](https://github.com/fengjixuchui/emp3r0r/commit/3741b362e9c73cac643a65eb65de54e13989843d))
* minor bugs and code optimization ([5e72139](https://github.com/fengjixuchui/emp3r0r/commit/5e72139b4492e97a19bd94ee2ba2f1c2f3521bbe))
* module start scripts don't need compression ([aa4869f](https://github.com/fengjixuchui/emp3r0r/commit/aa4869f05573f1fba090a6134353e80a7963c517))
* more randomized persistence (WIP) ([76686b1](https://github.com/fengjixuchui/emp3r0r/commit/76686b1ecf35bfe50a5d0ae72d23b949739ee59f))
* ncsi switch broken ([90fe415](https://github.com/fengjixuchui/emp3r0r/commit/90fe415433a7e27700c7c05c0d6652f84d8d2757))
* new `cc_host` not added to server cert, old names get repeated ([e3ef171](https://github.com/fengjixuchui/emp3r0r/commit/e3ef1710fe8b2c679027984a30a98af9294ab687))
* no error reported when `lpe_helper` fails ([39284ab](https://github.com/fengjixuchui/emp3r0r/commit/39284ab9645f8597d5962055d8a45e6ea198f751))
* no need to compress module when it already exists ([54cdd18](https://github.com/fengjixuchui/emp3r0r/commit/54cdd1877b86ceb57a7cc9e1ccc1d5dc3825c813))
* no need to keep validating the reverse proxy when a working proxy is configured ([144ca1e](https://github.com/fengjixuchui/emp3r0r/commit/144ca1e61fd0ede635cdedddfa7804419c85996b))
* only attemp SFTP on Linux ([fd36ff9](https://github.com/fengjixuchui/emp3r0r/commit/fd36ff91c202497f0b0192111132b12ca08f8a04))
* only extract `bashrc` when needed ([d51e78c](https://github.com/fengjixuchui/emp3r0r/commit/d51e78c8d4b96748417c271c9abb23b0742985da))
* open sftp in new tmux window to save space ([c29b8c1](https://github.com/fengjixuchui/emp3r0r/commit/c29b8c15115d8f53c42652ba743442c24c275bfe))
* optimize custom module handler ([e27a6df](https://github.com/fengjixuchui/emp3r0r/commit/e27a6df8ae38bebdba2302cbdb352dd6fef08f82))
* panic on HTTP2 server ([45d0ff7](https://github.com/fengjixuchui/emp3r0r/commit/45d0ff786581c8078db789c0b8493620131878ee))
* path searching: crash ([e982019](https://github.com/fengjixuchui/emp3r0r/commit/e9820193796fbb4631b23bed9ac6d8deab1ab1b6))
* path searching: crash ([24ff532](https://github.com/fengjixuchui/emp3r0r/commit/24ff5328a7787371fc4dd713fde95c34ebc001ea))
* permission error for Linux modules ([bf0ab59](https://github.com/fengjixuchui/emp3r0r/commit/bf0ab5983dcada63541bccedddecb06a3095fcd5))
* persistence using profiles ([#260](https://github.com/fengjixuchui/emp3r0r/issues/260)) ([409f51c](https://github.com/fengjixuchui/emp3r0r/commit/409f51cbf16ca21fee455f2aa347fdb750b9fd1d))
* port_fwd should print some feedback ([1c6844f](https://github.com/fengjixuchui/emp3r0r/commit/1c6844f53eeab5f81a95c8702060bd64dc180966))
* possible crash ([e568438](https://github.com/fengjixuchui/emp3r0r/commit/e56843899a3b086eddf670b9d50ea142fda95f65))
* prefer custom bash binary ([9c13feb](https://github.com/fengjixuchui/emp3r0r/commit/9c13febeed5556691ca10b4d7d551110dfa302ad))
* program header parser should run only once ([7c8940a](https://github.com/fengjixuchui/emp3r0r/commit/7c8940af4e24505a7c612ba6ee9cf6b78f088e6b))
* python modules broken ([11995cb](https://github.com/fengjixuchui/emp3r0r/commit/11995cb593051387f173fe256d7fd21282ff0897))
* randomize agent root even more (Linux) ([e96511c](https://github.com/fengjixuchui/emp3r0r/commit/e96511ce17c1b9fda504c8869a07bfd14704c8f3))
* randomize proxyDialer sleep time ([aa212d5](https://github.com/fengjixuchui/emp3r0r/commit/aa212d5610e5c23a31d4a175a2451a34246e6006))
* re-implement kcp C2 based on kcptun, use single UDP connection ([331b857](https://github.com/fengjixuchui/emp3r0r/commit/331b8575dbd765d822021ec928489a1fae55f83e))
* reduce CPU load ([2f5ed34](https://github.com/fengjixuchui/emp3r0r/commit/2f5ed34f72ca41d44d2e08a8747307a9ba631fa3))
* reduce embeded file size using xz ([79f76e1](https://github.com/fengjixuchui/emp3r0r/commit/79f76e17a677a7e632d904aa4d3a26d55c10e6e9))
* redundant port mappings for SSH shells ([7c0da2b](https://github.com/fengjixuchui/emp3r0r/commit/7c0da2b864356d853bf84880213c5cf7e2ee5df0))
* refactor: merge Linux/Windows agent code ([db70d70](https://github.com/fengjixuchui/emp3r0r/commit/db70d702dad6e7033310b9c7cbecd57a5bc2aed7))
* release-please: switch to `tar.zst` ([d430c7d](https://github.com/fengjixuchui/emp3r0r/commit/d430c7d2fe05f334c51af270280e99a2c9c624dd))
* remove `archiver/v3` ([#318](https://github.com/fengjixuchui/emp3r0r/issues/318)) ([03e6367](https://github.com/fengjixuchui/emp3r0r/commit/03e6367988fd10369f8ddd4d8b0d8dffa82b3eec))
* remove `go-lpe` as it's not very useful ([756d4ed](https://github.com/fengjixuchui/emp3r0r/commit/756d4eddc43469c5f79e9aacce60c41eb03149bf))
* remove unnecessary colors in "system info" ([ca14ba1](https://github.com/fengjixuchui/emp3r0r/commit/ca14ba1c11a572de354ca1a74ea7247a6e0db10f))
* req verification for `DownloadViaCC` ([e40db33](https://github.com/fengjixuchui/emp3r0r/commit/e40db33f985beb572758a18a3b9d4d010bea6f64))
* restore patched ELF's timestamps (mtime, atime) ([8d7ac5e](https://github.com/fengjixuchui/emp3r0r/commit/8d7ac5e368ae08060bbdfff9f57e7cac5e4d27e0))
* save agents' output to a log file ([d1b19f7](https://github.com/fengjixuchui/emp3r0r/commit/d1b19f7115b3381221fb265be2618962e4c227a0))
* scripts unable to run ([32a808a](https://github.com/fengjixuchui/emp3r0r/commit/32a808aa37a646b1a64e60fcfb347f892ccbd4fe))
* security issue in `archiver` ([ffd261e](https://github.com/fengjixuchui/emp3r0r/commit/ffd261e610ddbc77fcaf9c197b5c5d8fc7d1f22f))
* shell pane unable to start when run from loader.so ([2b6d3ea](https://github.com/fengjixuchui/emp3r0r/commit/2b6d3ea5b10085cdca82f9f4adfd516767463c10))
* should report C2 transport proxy if it's used ([4519725](https://github.com/fengjixuchui/emp3r0r/commit/45197252ee8b4c3f76dfed743f40c120c5f92767))
* show C2 address in agent system info ([7032d34](https://github.com/fengjixuchui/emp3r0r/commit/7032d34c0d546264335664048213d0a9767010ec))
* simple stagers ([a6d191d](https://github.com/fengjixuchui/emp3r0r/commit/a6d191df9f349accf91c92f0d1f083373b147a47))
* socket listener not running ([26802d0](https://github.com/fengjixuchui/emp3r0r/commit/26802d0630be8b2e0cd366526325d739c73cc0d5))
* some crypto functions ([e425081](https://github.com/fengjixuchui/emp3r0r/commit/e4250812b50ba6ce252a43dc405c529ff0584767))
* some traffic bypasses shadowsocks/kcp proxy ([a45b14c](https://github.com/fengjixuchui/emp3r0r/commit/a45b14cc44e48ca0b50a3ee6b844167a8741f1fd))
* sometimes CA cert is not added to agent config ([a003cd0](https://github.com/fengjixuchui/emp3r0r/commit/a003cd07de64f9f22ebd8ddd49b3fcfdb88802d4))
* sort hidden_pids list ([a63dcef](https://github.com/fengjixuchui/emp3r0r/commit/a63dcef6cd3db73d09d5d4a2e431221aafdae808))
* ssh C2 relay client should retry connection until SSH session is established ([966147b](https://github.com/fengjixuchui/emp3r0r/commit/966147b4f0199022576141aeef93c99bfff78972))
* ssh reverse proxy in KCP mode: client port should be renewed with each session ([e8b2649](https://github.com/fengjixuchui/emp3r0r/commit/e8b26490e81dcf61968eaf1fb8c9bcae78188c99))
* ssh reverse proxy in KCP tunnel now working ([30935fc](https://github.com/fengjixuchui/emp3r0r/commit/30935fc71b5440c4330f617f8ab3c12118a1264a))
* switch to `arc` as `archiver` is deprecated ([17ed290](https://github.com/fengjixuchui/emp3r0r/commit/17ed290b4917f868c76a8fea4abb2efb9021cba5))
* switch to `archives` as `archiver` is deprecated ([de0b493](https://github.com/fengjixuchui/emp3r0r/commit/de0b4932338db2664b01938bd3b9a0ee4a4f3d66))
* throw error if shellcode is empty ([06b6549](https://github.com/fengjixuchui/emp3r0r/commit/06b654961829f8cd4924848ca8448e7129201000))
* tmux config: status bar scripts not working ([db9ba69](https://github.com/fengjixuchui/emp3r0r/commit/db9ba6990a62de520557db29ee2c64e5aa7b7441))
* tmux history length too small ([c15fe26](https://github.com/fengjixuchui/emp3r0r/commit/c15fe26a0151adabb113ec73df05abd41b993302))
* tmux keeps switching back to home window ([ad9d887](https://github.com/fengjixuchui/emp3r0r/commit/ad9d887989890037f0b818d2c1a03b40af376c92))
* trying to obtain output ([b90975f](https://github.com/fengjixuchui/emp3r0r/commit/b90975f3ef7ec71963b1e47134bc11b13710511b))
* turn off NCSI by default ([b4c4940](https://github.com/fengjixuchui/emp3r0r/commit/b4c4940f640a6cf31bf04c99ea414131bec830ae))
* typo ([326461c](https://github.com/fengjixuchui/emp3r0r/commit/326461c3b2534adef93699cd52b71438cbf80fdc))
* typo in stager name ([442252d](https://github.com/fengjixuchui/emp3r0r/commit/442252dd95dbfbf8566294e69aaf2ad0d3aa4d8f))
* UI adjustments and code refactor ([f6b2d00](https://github.com/fengjixuchui/emp3r0r/commit/f6b2d00df39a06dbe23a911767bf6aa8ec3794cf))
* unable to find agent executable file when run from loaders (eg. shared lib) ([1140a3b](https://github.com/fengjixuchui/emp3r0r/commit/1140a3bc56e08c41f66b30eb9383138b6a6d5af1))
* unable to find config data in shellcode mode ([d99be9f](https://github.com/fengjixuchui/emp3r0r/commit/d99be9ffb853b8d19b3ac36aa192dee8e7506613))
* unable to read config when started by loader.so ([9074fc4](https://github.com/fengjixuchui/emp3r0r/commit/9074fc4ddc8ea90851acdad8833f0007a9cc92b2))
* unable to run from ELF loader if `VERBOSE` is `false` ([ad9aab2](https://github.com/fengjixuchui/emp3r0r/commit/ad9aab27f463bd7bb7581c0f63e16d1479ac9709))
* unable to view crash log in C2 client ([152ecf5](https://github.com/fengjixuchui/emp3r0r/commit/152ecf52672e7a2d93c799261087321921a080a8))
* unix socket listener may fail when path name is too long ([d7c0e98](https://github.com/fengjixuchui/emp3r0r/commit/d7c0e98415eccd1d090f9ebf2d0675488e21fb00))
* unix socket not set up ([313b4c9](https://github.com/fengjixuchui/emp3r0r/commit/313b4c92538a200b2a21645813d69eab2cb0b22b))
* unix socket path not match ([3e67009](https://github.com/fengjixuchui/emp3r0r/commit/3e67009dcbb23f3fb10825a1095837934c32a27c))
* update `gen_agent` help ([5db7099](https://github.com/fengjixuchui/emp3r0r/commit/5db7099eb6ee8530ac7a2ac44242e474611ea6a9))
* update `loader.so` ([22eaf46](https://github.com/fengjixuchui/emp3r0r/commit/22eaf46f22b6260f5ed3cbe4a61a6af8561621ab))
* update deps ([f4b177f](https://github.com/fengjixuchui/emp3r0r/commit/f4b177fe287448df7e3bd4d403bc037e6510c4f3))
* update deps ([f401df2](https://github.com/fengjixuchui/emp3r0r/commit/f401df25736889402d66719b2bee6588e8faf168))
* update deps ([298f87c](https://github.com/fengjixuchui/emp3r0r/commit/298f87c380adfa13c90c656bec5cf3e5c3517e63))
* update deps ([2aabc1e](https://github.com/fengjixuchui/emp3r0r/commit/2aabc1e3d70b9d5a37b3c80f0c3c452dcc44e947))
* upgrade `golang.org/x/net` ([78ac77b](https://github.com/fengjixuchui/emp3r0r/commit/78ac77bb0c0ef83c812bc980c01390f018d11489))
* upgrade `mholt/archiver` ([898e4a4](https://github.com/fengjixuchui/emp3r0r/commit/898e4a499d8558b4e016713fbdb926d4a849e11b))
* upload checksum file to release ([8d49717](https://github.com/fengjixuchui/emp3r0r/commit/8d4971750473e6a4d04e59636d379e8f73559b99))
* use `bash` shell when started by loader.so ([d12bda5](https://github.com/fengjixuchui/emp3r0r/commit/d12bda599bf01994ca2fd2e612511fb6b0a3fb8e))
* use `tmux-256color` as recommended by tmux documentation ([08da828](https://github.com/fengjixuchui/emp3r0r/commit/08da828726c7620eeaa1e6b9ca74755482c90eff))
* use base64 encoding for bash stager ([4d9657c](https://github.com/fengjixuchui/emp3r0r/commit/4d9657c5edb22c6c5474d55d38ec365601396201))
* use donut from upstream to support compression and latest features ([a212200](https://github.com/fengjixuchui/emp3r0r/commit/a2122004c6b25fffcc9aeb0dd99e380a60dc3add))
* use Go's built-in filepath sanitization ([db76751](https://github.com/fengjixuchui/emp3r0r/commit/db767513f4e9dbd2a12aa954e40e17426a0b58ad))
* use shadowsocks with kcptun by default ([791736d](https://github.com/fengjixuchui/emp3r0r/commit/791736de3f295d486f41896999103ff814dcbde5))
* use trusted built-in CA pool ([8ae44f0](https://github.com/fengjixuchui/emp3r0r/commit/8ae44f0eab5b1f9df8608da33861ddf4a711a0b6))
* UUID is all zero for Windows ([fd487d6](https://github.com/fengjixuchui/emp3r0r/commit/fd487d615c60b65b98b7c62f12994d497c24b9ff))
* verbose ([9786e1f](https://github.com/fengjixuchui/emp3r0r/commit/9786e1fdd452650f07971c45cc72344ec8c5b4e1))
* verify encrypted config data before using ([f716bc6](https://github.com/fengjixuchui/emp3r0r/commit/f716bc689cdbdf5f7fdcc23c47c1bb12b364a8b6))
* winpeas: support both ps1 and batch format ([0ebd71c](https://github.com/fengjixuchui/emp3r0r/commit/0ebd71c0b5d89c01b1b7a3b86d36c0f28704063d))
* word wrapping issues ([9ab1786](https://github.com/fengjixuchui/emp3r0r/commit/9ab178673b50af9595ab897b456d030919ae4726))
